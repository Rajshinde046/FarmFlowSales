...
class _DiscountState extends State<Discount> {
  ...
  Widget build(BuildContext context) {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            (
                              ...
                              onChanged: (p0) {
                                tecMonthly.clear();
                                controllerMySub.changeInvestmentAmount(tecOneTime.text);
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            inputField(
                              ...
                              onChanged: (p0) {
                                tecOneTime.clear();
                                controllerMySub.changeInvestmentAmountMonthly(tecMonthly.text);
                        ...
                        RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text: controllerMySub.investmentAmount.toString(),
                                // text: '12*  = 1,20,000',
                                style: GoogleFonts.poppins(
                                  fontSize: 16 * ffem,
                                  fontWeight: FontWeight.w700,
   ...
   fontSize: 16.sp,
                            ...
                            Text(
                              // j8P (18:55)
                              controllerMySub.intInvestMentAmount.toString(),
                              // '₹ 2,00,000/-',
                              style: GoogleFonts.poppins(
                                   fontSize: 16.sp,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              'Fees (${controllerMySub.feePercent}%)',
                              style:GoogleFonts.poppins(
                                    fontSize: 16.sp,
                                fontWeight: FontWeight.w400,
                                // height: 1.1000000238 * ffem / fem,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              controllerMySub.discount!.toStringAsFixed(2),
                              // j8P (18:55)
                              // '-₹ 1,000/-',
                              style: GoogleFonts.poppins(
                                    fontSize: 16.sp,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              controllerMySub.totalPayable!.toStringAsFixed(2),
                              // j8P (18:55)
                              // 'Total Payable',
                              style: GoogleFonts.poppins(
                                  fontSize: 16.sp,
...
class MySubController extends GetxController{
  ...
  changeInvestmentAmount(String value){
    ...
    }else if(_intInvestMentAmount! >= 1000000 && _intInvestMentAmount! < 2500000) {
      _feePercent = 1.25;
      _fee = ((_intInvestMentAmount!/100)*_feePercent!);
    } else if(_intInvestMentAmount! >= 2500000 && _intInvestMentAmount! < 5000000) {
      _feePercent = 1;
      _fee = ((_intInvestMentAmount!/100)*_feePercent!);
    } else {
      _feePercent = 0.75;
