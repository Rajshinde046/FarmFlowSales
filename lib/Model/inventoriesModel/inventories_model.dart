class InventoriesDataModel {
  ...
  InventoriesDataModel({this.status, this.success, this.data, this.message});

  InventoriesDataModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    success = json['success'];
    if (json['data'] != null) {
      data = <InventoriesData>[];
      json['data'].forEach((v) {
        data!.add(InventoriesData.fromJson(v));
      });
    }
...
class Lots {
  ...
  Lots.fromJson(Map<String, dynamic> json) {
    itemMasterXid = json['item_master_lot_xid'];
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['item_master_lot_xid'] = itemMasterXid;
    data['item_lot_xid'] = itemLotXid;
